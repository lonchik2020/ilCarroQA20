...
public class TestNGListener implements ITestListener {
    ...
    Logger logger = LoggerFactory.getLogger(TestNGListener.class);//creation of Logger

    @Override
    public void onTestStart(ITestResult result) {
        logger.info("stared test: " + result.getName());
    ...
    public void onStart(ITestContext context) {
        logger.info("start test - on start - :" + context.getName());
